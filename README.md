...
**0.5.0 candidate — Natural reader-facing responses**
...
[中文](README.zh-CN.md) · [Protocol](PROTOCOL.md) · [This iteration](docs/releases/0.5.0.md) · [Version sequence](docs/release-sequence.md)
...
Install the repository-root Skill from branch `codex/release-v05-presentation`, then reload as required
...
**38 deterministic fixtures** and a contract consistency check are provided:
