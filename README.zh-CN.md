...
**0.4.0 candidate — 准确等待**

先让用户看清 AI 接收到什么，再进行实质回应。回讲保留原意、限定、修正与未决项；
回讲不等于事实核验或行动授权。

[English](README.md) · [协议](PROTOCOL.md) · [本版迭代记录](docs/releases/0.4.0.md) · [版本路线](docs/release-sequence.md)

## 本版解决什么

准确等待。本版基于前一候选逐步演进，不把后续版本能力算作已经完成。
...
从本候选分支 `codex/release-v04-waiting` 安装仓库根目录中的 Skill，并按宿主要求重新加载。
不要将默认 main 安装误认为安装了本候选。仅安装不证明每轮自动应用。

本版有 **34 个确定性 fixtures**。检查：
