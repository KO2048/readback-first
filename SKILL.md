...
Every default installation MUST include [the host adapter](docs/always-on.md).
...
The installing agent must configure this profile; runtime evidence is still required.
